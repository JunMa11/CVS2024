...
from autoaugment import AutoAugmentModel
...
class CVSData(Dataset):
    ...
    def __init__(self, frames_path, labels_path, transform=None, auto_aug=False):
        ...
        if auto_aug:
            self.auto_aug = AutoAugmentModel()
        else:
            self.auto_aug = None
