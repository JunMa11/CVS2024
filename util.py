...
#%% create data split
s_frame_path = '/cluster/projects/bwanggroup/jma/data-CVS/train2/frames'
val_frame_path = '/cluster/projects/bwanggroup/jma/data-CVS/val/frames_val'
os.makedirs(val_frame_path, exist_ok=True)
videos = sorted(os.listdir(s_frame_path))
# uniformally sample 80% videos as validation set
for video in videos[::5]:
    os.rename(join(s_frame_path, video), join(val_frame_path, video))
